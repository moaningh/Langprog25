...
class Test {
	//Передаваемый обобщённый параметр типа ограничивается классом B и его потомками
	static void test(Gen1<? extends B> o) {
	}
	//Передаваемый обобщённый параметр типа ограничивается классом B_A и его родителями
...
//Класс, реализующий обобщённый интерфейс должен быть также обобщённым
	T[] arrayRef;
	ClassGenInt(T[] o) {
		arrayRef = o;
	}
...
//При реализации обобщённого интерфейса можно ограничить тип данных в объявлении интерфейса:
...
class Pr002 {
	public static void main(String args[]) {
		...
		//Демонстрация использования обобщённого метода arraysEqual(), определённого в классе GenMeth
		Integer nums[] = {1, 2, 3, 4, 5};
		Integer nums2[] = {1, 2, 3, 4, 5};
		Integer nums3[] = {1, 2, 7, 4, 5};
		Integer nums4[] = {1,2, 7, 4, 5, 6};
		
		System.out.println("\nВызов обобщённого метода для сравнения массивов");
		...
		//Использование класса Summation с обобщённым конструктором
		System.out.println();
